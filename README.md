# SHIJKPlayer
In view of someone asking me how to implement the separate video playback, to demo or static library and source code, to write a demo here for everyone to use, to use the latest bilibili's IJKPlayer
